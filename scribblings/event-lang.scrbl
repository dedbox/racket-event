...
@deftogether[(
  ...
  #,(var ...)] or @var[Es] in order and then applies @racket[values] to a list
...
@deftogether[(
  ...
  #,(var ...)] or @var[Es] in order and then applies @var[f] to a list of the
...
@deftogether[(
  ...
  @racket[#,(var E) #,(var ...)] or @var[Es] in order and then applies the
...
@deftogether[(
  ...
  Returns a @rtech{synchronizable event} that synchronizes @racket[#,(var E)
  #,(var ...)] or @var[Es] in order and then becomes the event returned from
...
@deftogether[(
  ...
  @example[
    (with-handlers ([number? values])
      (sync
       (loop
        (λ (x) (if (< x 10) (pure (add1 x)) (raise x)))
        0)))
  ]
}
